// Tiny stroke icons drawn as SVG, ported from prototype/icons.jsx.
// Kept as inline SVG (rather than swapping in lucide-react) so the visual
// language is identical to the prototype.
...
export function LASCrest({ size = 18 }: { size?: number }) {
  return (
